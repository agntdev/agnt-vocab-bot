...
const HELP =
  "Use your private decks to practise a little each day. Tap Study to reveal and rate each card, then VocabSprint plans the next review.\n\n" +
  "Tap /start whenever you want the menu back.";
